    ...
    <div class="content">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            <?php if ($sales_promotions) { ?>
            <?php foreach ($sales_promotions as $sales_promotion) { ?>
            <tr>
              <td style="text-align: center;"><?php if ($sales_promotion['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $sales_promotion['sales_promotion_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $sales_promotion['sales_promotion_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $sales_promotion['name']; ?></td>
              <td class="right"><?php echo $sales_promotion['discount']; ?></td>
              <td class="left"><?php echo $sales_promotion['date_start']; ?></td>
              <td class="left"><?php echo $sales_promotion['date_end']; ?></td>
              <td class="left"><?php echo $sales_promotion['status']; ?></td>
              <td class="right"><?php foreach ($sales_promotion['action'] as $action) { ?>
