    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="discount" class="list">
            ...
            <?php $discount_row = 1; ?>
            <?php  for ($num = 1; $num <= $discount_count_rows_num; $num++) { 
                ...
                <tbody id="discount-row<?php echo $discount_row; ?>">
                    <tr>  
                        <td class="left"><input type="text" name="<?php echo $discount_count_row_count;?>" value="<?php echo $$discount_count_row_count; ?>" size="5" /></td>
                        <td class="left"><input type="text" name="<?php echo $discount_count_row_proc;?>" value="<?php echo $$discount_count_row_proc; ?>" size="5" /><b> (%)</b></td>
        ...
        <input type="text" id="rows_num" style="display:none" name="discount_count_rows_num" value="<?php echo $discount_count_rows_num; ?>" />
                   
        <table class="form">
            <tr>
                <td><?php echo $entry_sum; ?></td>
                <td><select name="discount_count_sum">
                        <?php if ($discount_count_sum) { ?>
                        <option value="1" selected="selected"><?php echo $text_sum; ?></option>
                        <option value="0"><?php echo $text_sum_all; ?></option>
                        <?php } else { ?>
                        <option value="1"><?php echo $text_sum; ?></option>
                        <option value="0" selected="selected"><?php echo $text_sum_all; ?></option>
                        <?php } ?>
                </select></td>
            </tr>
            <tr>
                <td><?php echo $entry_group; ?></td>
                <td><select name="discount_count_group">
                  <option value="0"><?php echo $text_all; ?></option>
                  <?php if ($discount_count_group == 777) { ?>
                  <option value="777" selected="selected"><?php echo $text_login; ?></option>
                  <?php } else { ?>
                  <option value="777"><?php echo $text_login; ?></option>
                  <?php } ?>
                  <?php foreach ($customer_groups as $customer_group) { ?>
                  <?php if ($customer_group['customer_group_id'] == $discount_count_group) { ?>
            ...
            <tr>
                ...
                <td>
                    <select name="discount_count_status">
                        <?php if ($discount_count_status) { ?>
            ...
            <tr>
                ...
                <td><input type="text" name="discount_count_sort_order" value="<?php if (isset($discount_count_sort_order) && $discount_count_sort_order <> 0) echo $discount_count_sort_order;  else  echo '5';  ?>" size="1" /></td>
            </tr>
            <tr>
...
function addDiscount() {
	...
	html += '  <tr>'; 
            html += '    <td class="left"><input type="text" name="discount_count_row' + discount_row + '_count" value="<?php echo ''; ?>" size="5" /></td>';
            html += '    <td class="left"><input type="text" name="discount_count_row' + discount_row + '_proc" value="<?php echo ''; ?>" size="5" /><b> (%)</b></td>';
