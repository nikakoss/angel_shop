...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="sform">
    ...
    <div class="content">
	 ...
	 <div class="entry-theme">
		...
		<select name="themecontrol[default_theme]">
		 ...
		 - <a rel="" class="green custom-popup" href="http://www.themelexus.com/guides/<?php echo $module['default_theme']?>" id="btn-guide"><?php echo $this->language->get('UserGuide');?></a>
		...
		<div id="tab-contents">
				...
				<div id="tab-support">
					...
					<h4>Lexus Base Opencart Theme</h4>
					<p><i>
					We are proud to announce the next release of our Lexus Opencart Framework, version 2.0. 
					...
					<h4>About Lexus Opencart Framework</h4>
					<div>
						<p class="pavo-copyright">Lexus is Free Opencart Theme Framework released under license GPL/V2. Powered by <a href="http://www.themelexus.com" title="ThemeLexus - Opencart Theme Clubs">ThemeLexus</a></p>
					</div>
					<h4>Supports</h4>
					<div>
						Follow me on <b>twitter </b>or join my <b>facebook </b>page to get noticed about all theme updates and news!
						<ul>
							<li><a href="http://www.themelexus.com/supports/lexus-framework-2.html" target="_blank"> Framework 2 Guides</a></li>
							<li><a href="http://www.themelexus.com" target="_blank">Forum</a></li>
							<li><a href="http://www.themelexus.com" target="_blank">Ticket</a></li>
							<li><a href="http://www.themelexus.com" target="_blank">Contact us</a></li>
							<li>Email: <a href="mailto:themelexus@gmail.com" target="_blank">themelexus@gmail.com</a> </li>
							<li><a href="http://www.youtube.com/user/ThemeLexus" target="_blank">YouTuBe</a></li>
						</ul>
					</div>
 ...
 <script type="text/javascript"><!--
	...
	CKEDITOR.replace('customtab-content1-<?php echo $language['language_id']; ?>', {
		filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	...
	CKEDITOR.replace('customtab-content2-<?php echo $language['language_id']; ?>', {
		filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
