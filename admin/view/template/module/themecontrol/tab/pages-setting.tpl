			  			  ...
			  			  <div class="clearfix" id="tab-pproduct">
			  				<div class="tab-inner">
			  					<table class="form">
									...
									<!-- begin enable_product_customtab -->
			  			 			<tr>
									...
									<!-- end enable_product_customtab -->
									<!-- begin enable_product_customtab -->
			  			 			<tr>
			  			 				<td colspan="1"><h4><?php echo $this->language->get('text_add_product_tab');?> 2</h4></td>
			  			 				<td>
			  			 					<select name="themecontrol[enable_product_customtab1]">
			  			 						<?php foreach( $yesno as $k=>$v ) { ?>
			  			 					 		<option value="<?php echo $k;?>"  <?php if( $k==$module['enable_product_customtab1']){ ?> selected="selected" <?php } ?>><?php echo $v;?></option>
			  			 						<?php }  ?>	
			  			 					</select>
			  			 				</td>
			  			 			</tr>
			  			 			<tr>
			  			 				...
			  			 				<td colspan="2">
			  			 					...
			  			 					<?php   foreach( $languages as $language ) {  
			  			 							 ...
			  			 							 $customtab_name = isset($module['product_customtab_name1'][$language['language_id']])
			  			 							 				?$module['product_customtab_name1'][$language['language_id']] :"";
			  			 							 $customtab_content = isset($module['product_customtab_content1'][$language['language_id']])?$module['product_customtab_content1'][$language['language_id']]:"";				
			  			 					 ?>
			  			 						<tr>
			  			 						<td>  <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name'];?> 	</td>
			  			 						<td>
					  			 					 ...
					  			 					 <p><input size="80" type="text"  name="themecontrol[product_customtab_name1][<?php echo $language['language_id'];?>]" value="<?php echo $customtab_name;?>"/></p>
					  			 					 
					  			 					 <label> <?php echo $this->language->get('entry_customtab_content');?> 	
			  			 							<textarea id="customtab-content1-<?php echo $language['language_id']; ?>"  style="width:90%; height:300px" name="themecontrol[product_customtab_content1][<?php echo $language['language_id'];?>]"><?php echo $customtab_content;?></textarea>
			  			 						 	</td>
			  			 						</tr>
			  			 					<?php } ?>	
			  			 					</table>
									...
									<!-- begin enable_product_customtab -->
			  			 			<tr>
			  			 				<td colspan="1"><h4><?php echo $this->language->get('text_add_product_tab');?> 3</h4></td>
			  			 				<td>
			  			 					<select name="themecontrol[enable_product_customtab2]">
			  			 						<?php foreach( $yesno as $k=>$v ) { ?>
			  			 					 		<option value="<?php echo $k;?>"  <?php if( $k==$module['enable_product_customtab2']){ ?> selected="selected" <?php } ?>><?php echo $v;?></option>
			  			 						<?php }  ?>	
			  			 					</select>
			  			 				</td>
			  			 			</tr>
			  			 			<tr>
			  			 				...
			  			 				<td colspan="2">
			  			 					...
			  			 					<?php   foreach( $languages as $language ) {  
			  			 							 ...
			  			 							 $customtab_name = isset($module['product_customtab_name2'][$language['language_id']])
			  			 							 				?$module['product_customtab_name2'][$language['language_id']] :"";
			  			 							 $customtab_content = isset($module['product_customtab_content2'][$language['language_id']])?$module['product_customtab_content2'][$language['language_id']]:"";				
			  			 					 ?>
			  			 						<tr>
			  			 						<td>  <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name'];?> 	</td>
			  			 						<td>
					  			 					 ...
					  			 					 <p><input size="80" type="text"  name="themecontrol[product_customtab_name2][<?php echo $language['language_id'];?>]" value="<?php echo $customtab_name;?>"/></p>
					  			 					 
					  			 					 <label> <?php echo $this->language->get('entry_customtab_content');?> 	
			  			 							<textarea id="customtab-content2-<?php echo $language['language_id']; ?>"  style="width:90%; height:300px" name="themecontrol[product_customtab_content2][<?php echo $language['language_id'];?>]"><?php echo $customtab_content;?></textarea>
			  			 						 	</td>
			  			 						</tr>
			  			 					<?php } ?>	
			  			 					</table>
