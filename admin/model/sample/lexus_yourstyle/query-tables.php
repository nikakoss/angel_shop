<?php 
 ...
 $query['pavgallery'][]="CREATE TABLE IF NOT EXISTS  `".DB_PREFIX."banner` (
 ...
 $query['pavgallery'][]="CREATE TABLE IF NOT EXISTS  `".DB_PREFIX."banner_image` (
 ...
 $query['pavgallery'][]="CREATE TABLE IF NOT EXISTS  `".DB_PREFIX."banner_image_description` (
