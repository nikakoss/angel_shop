...
if( !class_exists("ModuleSample") ) {
	class ModuleSample  extends Model { 
		...
		public static function getTables(){
			...
			$tables['pavgallery']['banner'] = array( 'table' => 'banner', 'lang'=>false, 'module'=>'pavgallery' );
			$tables['pavgallery']['banner_image'] = array( 'table' => 'banner_image', 'lang'=>false, 'module'=>'pavgallery' );
			$tables['pavgallery']['banner_image_description'] = array( 'table' => 'banner_image_description', 'lang'=>true, 'module'=>'pavgallery' );
		...
		public static function getStoreConfigs(){
			return array(
					...
					'config_image_category_height' => 220,
					
					'config_image_thumb_width' =>500,
					'config_image_thumb_height' => 579,
					
					'config_image_popup_width' =>500,
					'config_image_popup_height' => 579,
					
					'config_image_product_width' =>500,
					'config_image_product_height' => 579,
					
					'config_image_additional_width' =>70,
					'config_image_additional_height' => 81,
					
					'config_image_related_width' =>500,
					'config_image_related_height' => 579,
