<?php
class ModelReportAdvCustomerOrderExportAll extends Model {
	public function getCustomerOrdersExportAll($data = array()) { 	 	
		...
		$sql .= " GROUP BY o.order_id ORDER BY date_added DESC";
	...
	public function getCustomerOrdersExportAllExcel($data = array()) { 	
		$query = $this->db->query("SET SESSION group_concat_max_len=500000");
