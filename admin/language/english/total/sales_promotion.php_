...
$_['entry_product_display']  = 'Product Display:<br /><span class="help">Enable/Disbale Promotion Details in Product Description<br/> By Default it will display on Product and Category Page.</span>';
$_['entry_sort_order'] = 'Sort Order:';

// Error
$_['error_permission'] = 'Warning: You do not have permission to modify Sales Promotion!';
?>