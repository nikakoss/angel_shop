...
<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">
    <div id="content"><?php echo $content_top; ?>
        ...
        $telephone_arr = explode('|', $telephone);
        $fax_arr = explode('|', $fax);
            ...
            <div class="row">
                <div class="contact-info col-lg-5 col-md-5 col-sm-12 col-xs-12">
                    ...
                    <div class="contact-address">
                        <p><?php echo $store; ?></p>
                        <ul>
                        <li><i class="fa fa-map-marker"></i><span><b><?php echo $text_address; ?></b><br /><?php echo trim($address_arr[1]); ?></span></li>
                            <?php if (isset($telephone_arr[1])) { ?>
                            <li><i class="fa fa-phone"></i><span><b><?php echo $text_telephone; ?></b><br /><?php echo trim($telephone_arr[1]); ?></span></li>
                            <?php } ?>
                            <?php if (isset($fax_arr[1])) { ?>
                            <li><i class="fa fa-hdd-o"></i><span><b><?php echo $text_fax; ?></b><br />
                                <?php echo trim($fax_arr[1]); ?></span></li>
                            <?php } ?>
                        </ul>
                    </div>
