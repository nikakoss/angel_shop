<div class="box box-product">
  ...
  <?php
   if($thickbox) { ?> <div id="frm_subscribe_hidden" > <?php } ?>
  ...
  <table>
   <tr>
     <td>
         <span class="title-subscribe"><b><?php echo $entry_email; ?></b></span>
         <input class="form-control" type="text" value="" name="subscribe_email" id="subscribe_email"></td>
   </tr>
