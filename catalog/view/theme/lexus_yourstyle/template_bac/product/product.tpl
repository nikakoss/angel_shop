    ...
    <div class="col-lg-6 col-md-6">
     <h1><?php echo $heading_title; ?></h1>
      ...
      <div class="description">
        ...
        <?php } ?>
        <span><?php echo $text_model; ?></span> Италия<!--?php echo $model; ?--><br />
        <?php if ($reward) { ?>
        <span><?php echo $text_reward; ?></span> <?php echo $reward; ?><br />
        <?php } ?>
        <!--span><?php echo $text_stock; ?></span> <?php echo $stock; ?><br /-->
        <span><?php echo $text_articul; ?></span><?php echo 10000 + $product_id; ?>
      </div>
      ...
      <?php } ?>
        ...
        <div class="product-extra">
            ...
            <span class="wishlist">
              <a class="fa fa-heart-o btn-theme-primary" onclick="addToWishList('<?php echo $product_id; ?>');" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo $button_wishlist; ?>">
              <span><?php echo $button_wishlist; ?></span>
              </a>
            </span>
            <span class="compare">
              <a class="fa fa-files-o btn-theme-primary" onclick="addToCompare('<?php echo $product_id; ?>');" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo $button_compare; ?>">
