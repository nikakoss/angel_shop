...
<div class="box product-related">       
      ...
      <?php if( $categoryPzoom ) { $zimage = str_replace( "cache/","", preg_replace("#-\d+x\d+#", "",  $product['thumb'] ));  ?>
        <a href="<?php echo $zimage;?>" id="colorbox_<?php echo $product['product_id'];?>" class="product-zoom hidden-xs hidden-sm" title="<?php echo $product['name']; ?>"><span class="fa fa-search-plus"></span></a>
      ...
      <?php } } ?>
        ...
        <?php //#2 Start fix quickview in fw?>
                <?php if ($quickview) { ?>
                        <a class="pav-colorbox left-position" href="<?php echo $this->url->link("themecontrol/product",'product_id='.$product['product_id'] );?>"><em class="fa fa-eye"></em><span><?php echo $this->language->get('quick_view'); ?></span></a>
                <?php } ?>
