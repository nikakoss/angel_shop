	...
	<div class="panelcontent ">
		<div class="panelinner">
			...
			<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="clearfix">
				...
				<p>
					<button value="Apply" class="btn btn-small btn-theme-default" name="btn-save" type="submit">Apply</button>
					<a class="btn btn-small btn-theme-default" href="<?php echo HTTP_SERVER; ?>?pavreset=?"><span>Reset</span></a>
				</p>
			</form>
		</div>	
	</div>
			                            ...
			                            <div class="accordion-inner panel-body clearfix">
			                              	<?php foreach ($group['selector'] as $item ) {  ?>
												 <?php  if (isset($item['type'])&&$item['type']=="image") { ?>
				                                  ...
				                                  <div class="form-group">
														<label><?php echo $item['label']?></label>
														<input value="" size="10" name="customize[<?php echo $group['match']?>][]" data-match="<?php echo $group['match']?>" type="text" class="input-setting" data-selector="<?php echo $item['selector']?>" data-attrs="<?php echo $item['attrs']?>"><a href="#" class="clear-bg btn btn-small btn-theme-default">Clear</a>
												  </div>
				                                  <?php } ?>
