	...
	<div class="panel-inner">
		<div>
			...
			<form action="" method="post">
				...
				<p>
					<button type="submit" name="btn-save" class="btn btn-small btn-theme-default" value="Apply"/>Apply</button>
					<a href="<?php echo $this->url->link('common/home',"pavreset=?");?>" class="btn btn-small btn-theme-default"><span>Reset</span></a>
				</p>
			</form>
		</div>
	</div>
