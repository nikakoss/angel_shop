      ...
      <div class="pav-filter-blogs">
         <div class="pav-blogs">
            ...
            <div class="leading-blogs clearfix">
               <?php foreach( $leading_blogs as $key => $blog ) { ?> <?php if( $key++%$cols == 0 ) { ?> 
               <div class="row">
                  <?php } ?> 
                  <div class="col-lg-<?php echo $span;?>"> <?php require( '_item.tpl' ); ?> </div>
            ...
            <div class="secondary clearfix">
               <?php foreach( $secondary_blogs as $key => $blog ) { ?> <?php if( $key++%$cols == 0 ) { ?> 
               <div class="row">
                  <?php } ?> 
                  <div class="col-lg-<?php echo $span;?>"> <?php require( '_item.tpl' ); ?> </div>
