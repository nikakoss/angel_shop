<div class="blog-item">
  ...
  <img src="<?php echo $blog['thumb'];?>" title="<?php echo $blog['title'];?>" alt="<?php echo $blog['title'];?>"> <?php } ?>
  <div class="row">
    <!--noindex-->
    <div class="blog-meta col-lg-3 col-md-3 col-sm-4 col-xs-12">
      <ul>
        <?php if( $config->get('cat_show_created') ) { ?>
          <li class="created"><span class="icon-time"> <?php echo $this->language->get("text_created");?> :</span><?php echo date("d-M-Y",strtotime($blog['created']));?></li>
        <?php } ?>
        ...
        <?php if( $config->get('cat_show_comment_counter') ) { ?>
          <li class="comment_count"><span class="icon-comments"> <?php echo $this->language->get("text_comment_count");?></span>
          <?php echo $blog['comment_count'];?></li>
        <?php } ?>
