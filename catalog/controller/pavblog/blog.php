 ...
 */
	class ControllerpavblogBlog extends Controller {
		...
		public function index() {  
			...
			$this->request->get['pavblog/blog'] = isset($this->request->get['pavblog/blog'])?$this->request->get['pavblog/blog']:0;
			$blog_id = $this->request->get['pavblog/blog'];
...
$sales= $this->model_checkout_sales_promotion->getSalesPromotionProduct($result['product_id']);						
			...
			// related_product				
				...
				$this->data['breadcrumbs'][] = array(
					'text'      => 'Блог',
					'href'      => $this->url->link('common/home').$this->mparams->get( 'keyword_listing_blogs_page' ),
				...
				*/
				$this->data['breadcrumbs'][] = array(
					'text'      => $blog['title'],
					'href'      => $this->url->link('pavblog/blog', 'pavblog/blog=' .  $blog_id),      		
					'separator' => $this->language->get('text_separator')
				);		
				...
				$blog['category_link'] =  $this->url->link( 'pavblog/category', "pavblog/category=".$blog['category_id'] );
				$blog['comment_count'] =  $this->getModel('comment')->countComment( $blog['blog_id'] );
				$blog['link'] =  $this->url->link( 'pavblog/blog','pavblog/blog='.$blog['blog_id'] );
				...
				$this->data['link'] =  $this->url->link( 'pavblog/blog','pavblog/blog='.$blog['blog_id'] );
				...
				$pagination->url = $this->url->link('pavblog/blog', 'pavblog/blog=' . $blog['blog_id'] . $url . '&page={page}');
				$data = array(
