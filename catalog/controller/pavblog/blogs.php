             ...
             *
                ...
                public function index() {  
                        ...
                        if( $filter || $filter_tag ){
                                ...
                                $this->document->setDescription( $this->language->get('blogs_latest_header_description') ); //ratkin added
                                $this->document->setKeywords( $this->language->get('blogs_latest_header_keywords') );  //ratkin added
                        } else {
