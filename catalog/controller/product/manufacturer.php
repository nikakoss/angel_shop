...
class ControllerProductManufacturer extends Controller {  
        public function index() { 
                ...
                $this->document->setDescription( $this->language->get('heading_description') ); //ratkin added
                $this->document->setKeywords( $this->language->get('heading_keywords') );  //ratkin added
        ...
        $this->data['breadcrumbs'][] = array(
                ...
                foreach ($results as $result) {
                                ...
                                $total = (int)$this->model_catalog_product->getTotalProducts(array('filter_manufacturer_id'  => $result['manufacturer_id']));
                                if($total>0){
                       if ($result['image']) {
