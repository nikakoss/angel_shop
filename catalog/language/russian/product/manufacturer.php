<?php
// Heading
$_['heading_title']     = 'Бренды | Angel-moda';
$_['heading_description']     = "В интернет магазине 'Angel-moda' представлены товары различных брендов. Большой ассортимент товаров для женщин и мужчин из Италии по приемлимым ценам. Принимаем заказы по тел. +7(929)580-08-10.";
$_['heading_keywords']     = 'бренды, итальянский, из Италии, одежда, обувь, купить';
