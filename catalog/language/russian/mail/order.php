...
$_['text_new_subject']          = 'Благодарим Вас за заказ в интернет-магазине Angel Moda.';
$_['text_new_greeting']         = 'Благодарим Вас за заказ в интернет-магазине Angel Moda. В данный момент Ваш заказ находится в обработке, с Вами свяжется наш менеджер в ближайшее время.';
