 ...
 */
 ...
 $_['text_like_this'] = 'Вам нравится эта :';
  ...
  $_['blogs_latest_header_title'] = 'Блог | Angel Moda';
  $_['blogs_latest_header_description'] = 'Читайте интересные статьи о моде в нашем блоге. Советы по подбору гардероба для женщин и мужчин. Итальянская брендовая одежда, обевь и аксессуары.';
  $_['blogs_latest_header_keywords'] = 'блог, статьи, angel moda, читать';
...
$_['bloglatest_all'] = 'Все статьи ' ;

// Подпись под аватаром
$_['text_latest'] = 'Блог Angel Moda' ;
$_['text_mostviewed'] = 'Самые популярные ';
$_['text_featured'] = 'Лучшее ' ;
$_['text_bestseller'] = 'Бестселлер ' ;
